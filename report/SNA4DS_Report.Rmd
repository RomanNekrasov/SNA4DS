...
plot(1:length(degree_distribution_in), degree_distribution_in, type = "h", lwd = 2, 
     main = "Indegree Distribution", xlab = "Indegree", ylab = "Frequency")
```
...
# Create a frequency plot with lines
plot(1:length(degree_distribution_out), degree_distribution_out, type = "h", lwd = 2, 
     main = "Outdegree Distribution", xlab = "Outdegree", ylab = "Frequency")
```
...
knitr::include_graphics("SNA4DS_Report_files/figures/transitive_triad_2.png")
```
