...
```{r}
make_snowballs <- function(G, sizes, order, mode = "all") {
  egos <- igraph::make_ego_graph(subgraph, order = 3)
  graphs <- c()
...
snowballs <- (make_snowballs(subgraph, order = 3, sizes = c(25, 50, 100, 150, 200), mode = "all"))
```
